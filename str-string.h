	...
	*	Note: For rvalues, a local move-constructed value of the receiver is held, otherwise a reference is held and it must not outlive the receiver */
	...
	namespace detail {
		...
		public:
			...
			constexpr StrType upper(std::string_view locale = {}) const {
				StrType out;
			...
			constexpr StrType lower(std::string_view locale = {}) const {
				StrType out;
			...
			constexpr StrType fold(std::string_view locale = {}) const {
				StrType out;
			...
			constexpr StrType inorm(std::string_view locale = {}) const {
				StrType out;
		...
		public:
			...
			constexpr bool isINorm(std::string_view locale = {}) const {
		...
		public:
			...
			constexpr bool icompare(const str::IsStr auto& str, std::string_view locale = {}) const {
				using OChType = str::StringChar<decltype(str)>;
				return fCompare<ChType, OChType>(std::basic_string_view<ChType>{ fBase() }, std::basic_string_view<OChType>{ str }, cp::NormFold{ locale });
			}

			/* perform a case-insensitive normalized comparison of this string and the other string */
			constexpr bool icompare(size_t pos1, size_t count1, const str::IsStr auto& str, std::string_view locale = {}) const {
				using OChType = str::StringChar<decltype(str)>;
			...
			/* perform a case-insensitive normalized comparison of this string and the other string */
			constexpr bool icompare(size_t pos1, size_t count1, const str::IsStr auto& str, size_t pos2, size_t count2, std::string_view locale = {}) const {
				using OChType = str::StringChar<decltype(str)>;
